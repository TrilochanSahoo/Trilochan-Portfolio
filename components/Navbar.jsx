    ...
    >
      ...
      <NavbarContent className="" justify="center">
        <NavbarBrand>
          <a href="/" className="font-black text-3xl dark:text-white">
            TS<span className="text-[#5418a1]">.</span>
          </a>
        </NavbarBrand>
      </NavbarContent>
      ...
      <NavbarContent className="dark:text-white text-black" justify="end">
        {menuItems.map((item, index) => (
          <NavbarItem
            key={index}
            className="hidden text-lg hover:text-[#fff] hover:transition hover:ease-out hover:duration-250 dark:text-[#d8d8d8] text-black sm:flex sm:justify-end sm:items-end"
          >
