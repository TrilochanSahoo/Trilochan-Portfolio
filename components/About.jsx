...
const About = () => {
  return (
    <>
      <div id="about" className='group relative pt-16 pb-10 max-w-24 mx-auto'>
      ...
      <BackgroundBeamsWithCollision>
        <section  className="py-20 max-w-4xl px-5 mx-auto dark:text-white flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left">
