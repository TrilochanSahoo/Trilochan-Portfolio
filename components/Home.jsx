...
export default function HomePage() {
  ...
  return (
    <>
      <div id="home" className="absolute w-full z-50">
        <Header />
      </div>
      <div className="h-screen flex justify-center items-center  max-w-full mx-auto pt-5 text-center dark:bg-grid-white/[0.1] bg-grid-black/[0.1] z-10 relative">
        <div className="absolute z-0 pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_40%,black)]"></div>
        <div className="bg-shadow">
          <div className="flex z-10 justify-center items-center flex-col">
            <div className="bg-[#030013] relative no-underline group shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
            ...
            Driven by curiosity, fueled by creativity. Building projects that stand out and make a difference.
            </p>
